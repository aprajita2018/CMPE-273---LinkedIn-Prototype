...
function handle_request(msg, callback){
    ...
    if(jobtitle==='' && address==='' && emptype ==='null' && jobapplytype==='null' )
    {
    ...
    {
        Jobs.find({
            address:address,jobtitle:jobtitle,easyapply:jobapplytype
       }, function(err,job){
           if (err) {
               res.code = "400";
               res.value = "Jobs not found. Try Again !!";
    ...
    {
        Jobs.find({
            address:address,jobtitle:jobtitle,senlevel:emptype
       }, function(err,job){
           if (err) {
               res.code = "400";
               res.value = "Jobs not found. Try Again !!";
    ...
    {
        Jobs.find({
            address:address,jobtitle:jobtitle,senlevel:emptype,easyapply:jobapplytype
       }, function(err,job){
           if (err) {
               res.code = "400";
               res.value = "Jobs not found. Try Again !!";
